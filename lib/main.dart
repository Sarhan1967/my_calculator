...
//====First Four Buttons on Calculator==================
/*
void main() => runApp(MyCalculator());
    ...
    Row(
              ...
              Row(
                  ...
                  children: <Widget>[
                    ...
                    button(".", Color.fromRGBO(50, 50, 50, 1.0), 1),
                    button("=", Color(0xffff9800), 1),
                  ]
              ),
          ],
...
//--Create function of three parameters (text and color)of the Button----
...
//--Create function of three parameters (text and color and opacy)of the  Zero Button----
Widget button(String btnTxt,Color color,int num){
  Container container;
